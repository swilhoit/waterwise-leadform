...
export default function Footer({
  companyName = 'Austin Greywater Solutions',
  tagline = 'Helping Austin homeowners save water since 2015',
}: FooterProps) {
  return (
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-2">
            ...
            <p className="text-slate-400 mb-6 max-w-md">
              {tagline}. We specialize in greywater recycling systems that help you save money while protecting Austin's precious water resources.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#lead-form" className="text-slate-400 hover:text-white transition-colors">Get a Quote</a></li>
